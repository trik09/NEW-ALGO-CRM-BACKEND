...
router.get(
  "/getAllQstClient-for-tableShow",
  isAuthenticated,
  qstClientController.getAlltheQstClientForShowInTable
);
router.post(
  "/create-qstClient",
  isAuthenticated,
...
router.get(
  "/getAllQstClient",
  isAuthenticated,
  qstClientController.getAllQstClients
);
...
router.get(
  "/exportQstClients",
  isAuthenticated,
  qstClientController.exportQstClients
);
router.patch(
  "/update-qstClient/:id",
  isAuthenticated,
...
router.get(
  "/get-client-by-qstuserId/:userId",
  isAuthenticated,
  qstClientController.getClientByqstUserId
);
